...
static constexpr auto qt_meta_stringdata_ZN6HeaderE = QtMocHelpers::stringData(
    "Header"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN6HeaderE[] = {
...
Q_CONSTINIT const QMetaObject Header::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6HeaderE.offsetsAndSizes,
    qt_meta_data_ZN6HeaderE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6HeaderE_t,
        // Q_OBJECT / Q_GADGET
...
void *Header::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6HeaderE.stringdata0))
